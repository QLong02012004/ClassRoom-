      ...
      <div className="p-6 space-y-4 bg-white">
        ...
        <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-end gap-2.5">
          <button
            ...
            className="px-4 py-2.5 rounded-xl font-bold text-slate-600 bg-white border border-slate-200 hover:bg-slate-100 transition-colors text-sm shadow-sm cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Đóng
          </button>
          ...
          <button
            ...
            disabled={isProcessing}
            className="px-4 py-2.5 rounded-xl font-bold text-rose-700 bg-rose-50 border border-rose-200 hover:bg-rose-600 hover:text-white transition-all text-sm shadow-sm cursor-pointer flex items-center gap-1.5 disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <button
            ...
            disabled={isProcessing}
            className="px-4 py-2.5 rounded-xl font-bold text-white bg-emerald-600 border border-emerald-600 hover:bg-emerald-700 transition-all text-sm shadow-sm cursor-pointer flex items-center gap-1.5 disabled:opacity-75 disabled:cursor-not-allowed"
          >
            {isProcessing ? (
              <>
...
export default function AdminUsers() {
  ...
  // State ngăn chặn spam duyệt / từ chối tài khoản Giáo viên
  ...
  useEffect(() => {
    ...
    socket.on('admin_stats_update', handleRealtimeUpdate);
