...
import { Eye, Pencil, Trash, LockKey, LockKeyOpen } from "phosphor-react";
...
export const QuizActionMenu: React.FC<QuizActionMenuProps> = ({
  onViewResults,
  onEdit,
  onDelete,
  onToggleStatus,
