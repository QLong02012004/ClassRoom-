          ...
          <ul>
            {onTogglePin && (
              <li>
                <button type="button" onClick={(e) => { e.preventDefault(); handleAction(onTogglePin); }}>
                  {isPinned ? (
                    <>
                      <PushPin size={16} weight="fill" className="text-amber-500" />
                      <span>Bỏ ghim lớp</span>
                    </>
                  ) : (
                    <>
                      <PushPin size={16} weight="bold" className="text-amber-500" />
                      <span>Ghim lớp học</span>
                    </>
                  )}
                </button>
              </li>
            ...
            <li>
              <button type="button" onClick={(e) => { e.preventDefault(); handleAction(onEdit); }}>
                <PencilSimple size={16} weight="bold" className="text-blue-500" />
            ...
            <li>
              <button type="button" onClick={(e) => { e.preventDefault(); handleAction(onArchive); }}>
                <Archive size={16} weight="bold" className="text-orange-500" />
                <span>Lưu trữ lớp</span>
              </button>
            </li>
          </ul>
        </nav>
